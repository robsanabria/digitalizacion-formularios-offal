...
const createSolicitud = async (req, res) => {
    ...
    try {
        ...
        const result = await pool.request()
            ...
            .input('rolSolicitante', sql.NVarChar(50), rolSolicitante)
            .input('fechaSolicitud', sql.Date, fechaSolicitud)
            .input('sectorSolicitante', sql.NVarChar(100), sectorSolicitante)
            .input('motivo', sql.NVarChar(sql.MAX), typeof motivo === 'string' ? motivo : JSON.stringify(motivo))
            .input('nombreProducto', sql.NVarChar(300), nombreProducto)
            .input('codigoProducto', sql.NVarChar(100), codigoProducto)
            .input('destino', sql.NVarChar(200), destino)
            .input('vidaUtil', sql.NVarChar(50), vidaUtil)
            .input('codigoSenasa', sql.NVarChar(100), codigoSenasa)
            .input('impresoras', sql.NVarChar(sql.MAX), typeof impresoras === 'string' ? impresoras : JSON.stringify(impresoras))
            .input('tipoEtiqueta', sql.NVarChar(sql.MAX), typeof tipoEtiqueta === 'string' ? tipoEtiqueta : JSON.stringify(tipoEtiqueta))
            .input('tara', sql.NVarChar(50), tara)
            .input('pesoMinimo', sql.NVarChar(50), pesoMinimo)
            .input('pesoMaximo', sql.NVarChar(50), pesoMaximo)
            .input('pesoEstandar', sql.NVarChar(50), pesoEstandar)
            .input('numCaja', sql.NVarChar(50), numCaja)
            .input('faja', sql.NVarChar(50), faja)
            .input('codigoExterno', sql.NVarChar(50), codigoExterno)
            .input('comentariosSolicitante', sql.NVarChar(sql.MAX), comentariosSolicitante)
            .input('cambioSolicitado', sql.NVarChar(sql.MAX), cambioSolicitado)
            .input('estado', sql.NVarChar(50), estadoInicial)
        ...
        await pool.request()
            ...
            .input('estadoNuevo', sql.NVarChar(50), estadoInicial)
            .input('accion', sql.NVarChar(200), 'Creación de REG-SIS-011')
            .query(`
    ...
    try {
        ...
        if (b.intent === 'reenviar_reg11' || estadoActual === 'REG-011-OBSERVADO') {
            ...
            await pool.request()
                ...
                .input('sectorSolicitante', sql.NVarChar(100), b.sectorSolicitante)
                .input('motivo', sql.NVarChar(sql.MAX), b.motivo == null ? null : (typeof b.motivo === 'string' ? b.motivo : JSON.stringify(b.motivo)))
                .input('nombreProducto', sql.NVarChar(300), b.nombreProducto)
                .input('codigoProducto', sql.NVarChar(100), b.codigoProducto)
                .input('destino', sql.NVarChar(200), b.destino)
                .input('vidaUtil', sql.NVarChar(50), b.vidaUtil)
                .input('codigoSenasa', sql.NVarChar(100), b.codigoSenasa)
                .input('impresoras', sql.NVarChar(sql.MAX), b.impresoras == null ? null : (typeof b.impresoras === 'string' ? b.impresoras : JSON.stringify(b.impresoras)))
                .input('tipoEtiqueta', sql.NVarChar(sql.MAX), b.tipoEtiqueta == null ? null : (typeof b.tipoEtiqueta === 'string' ? b.tipoEtiqueta : JSON.stringify(b.tipoEtiqueta)))
                .input('tara', sql.NVarChar(50), b.tara)
                .input('pesoMinimo', sql.NVarChar(50), b.pesoMinimo)
                .input('pesoMaximo', sql.NVarChar(50), b.pesoMaximo)
                .input('pesoEstandar', sql.NVarChar(50), b.pesoEstandar)
                .input('numCaja', sql.NVarChar(50), b.numCaja)
                .input('faja', sql.NVarChar(50), b.faja)
                .input('codigoExterno', sql.NVarChar(50), b.codigoExterno)
                .input('comentariosSolicitante', sql.NVarChar(sql.MAX), b.comentariosSolicitante)
                .input('cambioSolicitado', sql.NVarChar(sql.MAX), b.cambioSolicitado)
            ...
            await pool.request()
                ...
                .input('estadoAnterior', sql.NVarChar(50), estadoActual)
                .input('estadoNuevo', sql.NVarChar(50), nuevoEstado)
                .input('accion', sql.NVarChar(200), 'REG-SIS-011 corregido y reenviado a Sistemas')
                .input('comentario', sql.NVarChar(sql.MAX), b.comentario || null)
                .query(`
        ...
        await pool.request()
            ...
            .input('codigoTwins', sql.NVarChar(100), b.codigoTwins)
            .input('correspondeSolicitud', sql.NVarChar(100), b.correspondeSolicitud)
            .input('motivo', sql.NVarChar(sql.MAX), motivoJson)
            .input('observacionesSistemas', sql.NVarChar(sql.MAX), b.observacionesSistemas != null ? String(b.observacionesSistemas) : null)
            .input('estado', sql.NVarChar(50), nuevoEstado)
            .query(`
                UPDATE Solicitudes
        ...
        await pool.request()
            ...
            .input('estadoAnterior', sql.NVarChar(50), estadoActual)
            .input('estadoNuevo', sql.NVarChar(50), nuevoEstado)
            .input('accion', sql.NVarChar(200), 'Respuesta Sistemas (REG-SIS-007)')
            .query(`
                INSERT INTO Historial (SolicitudId, UsuarioId, EstadoAnterior, EstadoNuevo, Accion)
...
const addAdjunto = async (req, res) => {
    ...
    try {
        ...
        await pool.request()
            .input('solicitudId', sql.UniqueIdentifier, id)
            .input('nombreArchivo', sql.NVarChar(260), file.originalname)
            .input('rutaArchivo', sql.NVarChar(1024), url)
            .input('tipoContenido', sql.NVarChar(100), file.mimetype)
            .input('tamano', sql.BigInt, file.size)
            .input('tipoAdjunto', sql.NVarChar(50), tipo || 'PROPUESTO')
            .query(`
...
const transitionSolicitud = async (req, res) => {
    ...
    try {
        ...
        await pool.request()
            ...
            .input('estadoAnterior', sql.NVarChar(50), estadoActual)
            .input('estadoNuevo', sql.NVarChar(50), nuevoEstado)
            .input('accion', sql.NVarChar(200), accionDescripcion)
    ...
    try {
        ...
        try {
            await pool.request()
                .input('solicitudId', sql.UniqueIdentifier, id)
                .input('usuarioId', sql.UniqueIdentifier, UsuarioId)
                .input('estadoAnterior', sql.NVarChar(50), estado)
                .input('estadoNuevo', sql.NVarChar(50), estado)
                .input('accion', sql.NVarChar(200), `Eliminó adjunto — ${tipoLabel}`)
                .input('comentario', sql.NVarChar(sql.MAX), NombreArchivo || null)
                .query(`
                    INSERT INTO Historial (SolicitudId, UsuarioId, EstadoAnterior, EstadoNuevo, Accion, Comentario)
                    VALUES (@solicitudId, @usuarioId, @estadoAnterior, @estadoNuevo, @accion, @comentario)
                `);
    ...
    try {
        ...
        try {
            await pool.request()
                ...
                .input('estadoAnterior', sql.NVarChar(50), estado)
                .input('estadoNuevo', sql.NVarChar(50), estado)
                .input('accion', sql.NVarChar(200), `Cambió la prioridad — ${PRIORIDAD_LABELS[anterior] || anterior} → ${PRIORIDAD_LABELS[nueva]}`)
                .input('comentario', sql.NVarChar(sql.MAX), null)
                .query(`
                    INSERT INTO Historial (SolicitudId, UsuarioId, EstadoAnterior, EstadoNuevo, Accion, Comentario)
                    VALUES (@solicitudId, @usuarioId, @estadoAnterior, @estadoNuevo, @accion, @comentario)
                `);
